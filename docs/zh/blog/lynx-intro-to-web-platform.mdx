...
description: "Lynx Web 平台现已进入 Beta 阶段。Lynx 为开发者提供一流的浏览器支持，通过 Web Workers 实现双线程模型，带来更快的首次有效绘制（FMP）和非阻塞的 effect 执行。开发者可以用一套代码在浏览器中高性能渲染 ReactLynx 页面，借助 Web Components 实现类原生 UI，并遵循 W3C CSS 规范。"
---
...
_感谢[黄玄](https://x.com/huxpro)、[张磊](https://x.com/zoolsher)和[王清宇](https://x.com/colinqywang)在撰写此博客时提供的帮助。_
